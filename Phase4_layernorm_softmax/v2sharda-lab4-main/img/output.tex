...
\begin{document}
    ...
    \metarect{A_tilde}{$\tilde{A}$}{(32,768)}{8b}{24KB}{lightYellow}{}

    \metarect{G_tilde}{$\tilde{G}$}{(32,3072)}{8b}{96KB}{lightYellow}{right=\rectWidth*0.75pt of A_tilde.center}
    \node [draw, circle, fill=lightRed, minimum size=\multSize, right=\rectWidth*0.5pt of G_tilde] (multFF2) {\textbf{x}};
    \node [draw, circle, fill=lightRed, minimum size=\multSize, right=\rectWidth*0.5pt of multFF2] (addFF2) {\textbf{+}};
    ...
    \draw [-latex] (multFF2.east) -- (addFF2.west);
    \draw [-latex] (addFF2.east) -- (O.west);

    \draw [-latex] (A_tilde.north) -- ++(0pt,\rectHeight*3.75pt) -| (addFF2.north);
    ...
    \metarect{O_tilde}{$\tilde{O}$}{(32,768)}{8b}{24KB}{lightYellow}{right=\rectWidth*0.75pt of ln2.center}

    \draw [-latex] (O.east) -- (ln2.north);
    \draw [-latex] (ln2.south) -- (O_tilde.west);
