...
proc create_hier_cell_mm_eval { parentCell nameHier } {
  ...
  source args.tcl
  puts "Using the following parameters for mm: N1=$N1 N2=$N2 MEM_DEPTH_A=$MEM_DEPTH MEM_DEPTH_B=$MEM_DEPTH MEM_DEPTH_D=$MEM_DEPTH _BLOCK_NUM=$_BLOCK_NUM MATRIXSIZE_W=$MATRIXSIZE_W"
  set_property -dict [ list \
    CONFIG.N1 $N1 \
    CONFIG.N2 $N2 \
    CONFIG.MEM_DEPTH_A $MEM_DEPTH \
    CONFIG.MEM_DEPTH_B $MEM_DEPTH \
    CONFIG.MEM_DEPTH_D $MEM_DEPTH \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins mm_0/s_axi_AXILiteS]
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -range 0x00010000 -offset 0x43C10000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mm_eval/mm_0/s_axi_AXILiteS/reg0] -force
