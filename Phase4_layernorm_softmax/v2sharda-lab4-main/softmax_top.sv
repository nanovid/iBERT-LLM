...
#(
    ...
    parameter QB_MEM = "data/softmax/softmax_qb.mem",
    parameter QC_MEM = "data/softmax/softmax_qc.mem",
    parameter QLN2_MEM = "data/softmax/softmax_qln2.mem",
    parameter QLN2_INV_MEM = "data/softmax/softmax_qln2_inv.mem",
    parameter SREQ_MEM = "data/softmax/softmax_Sreq.mem"
)
(
    input  wire                      clk,
    input  wire                      rst,
