...
\begin{document}
    ...
    \metarect{G}{$G$}{(32,3072)}{8b}{384KB}{lightYellow}{right=\rectWidth*0.5pt of multFF1}

    \draw [-latex] (A_tilde.east) -- (multFF1.west);
    \draw [-latex] (weight_ff1.south) -- (multFF1.north);
    \draw [-latex] (multFF1.east) -- (G.west);
    ...
    \metarect{G_tilde}{$\tilde{G}$}{(32,3072)}{8b}{96KB}{lightYellow}{right=\rectWidth*0.75pt of gelu.center}
    \draw [-latex] (G.east) -- (gelu.north);
    \draw [-latex] (gelu.south) -- (G_tilde.west);
    \draw [-latex] (G_tilde.east) -- ++(1,0);
