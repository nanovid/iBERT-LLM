...
#   create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_AXILiteS
  ...
  # Create instance: ibert_0, and set properties
  set block_name ibert_axi
  set block_cell_name ibert_0
  if { [catch {set ibert_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  set_property -dict [ list \
    CONFIG.D_W $D_W \
    CONFIG.D_W_ACC $D_W_ACC \
    CONFIG.N1_HEAD $N1_HEAD \
    CONFIG.N2_HEAD $N2_HEAD \
    CONFIG.sN1_HEAD $sN1_HEAD \
    CONFIG.sN2_HEAD $sN2_HEAD \
    CONFIG.N1_SELF $N1_SELF \
    CONFIG.N2_SELF $N2_SELF \
    CONFIG.N1_INTER $N1_INTER \
    CONFIG.N2_INTER $N2_INTER \
    CONFIG.N1_LAYER $N1_LAYER \
    CONFIG.N2_LAYER $N2_LAYER \
    CONFIG.MATRIXSIZE_W $MATRIXSIZE_W \
    CONFIG.LAYERS $LAYERS \
    CONFIG.HEADS $HEADS \
    CONFIG.TOKENS $TOKENS \
    CONFIG.EMBED_SIZE $EMBED_SIZE \
    CONFIG.INTER_SIZE $INTER_SIZE \
    CONFIG.BLOCKS_HEAD $BLOCKS_HEAD \
    CONFIG.BLOCKS_SELF $BLOCKS_SELF \
    CONFIG.BLOCKS_INTER $BLOCKS_INTER \
    CONFIG.BLOCKS_LAYER $BLOCKS_LAYER \
    CONFIG.BLOCKED_D $BLOCKED_D \
    CONFIG.KEEP_A $KEEP_A \
    CONFIG.SLICES $SLICES \
    CONFIG.LN_BITS $LN_BITS \
  ] $ibert_0

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins ibert_0/x]
  ...
  connect_bd_intf_net -intf_net ibert_0_y [get_bd_intf_pins axi_dma/S_AXIS_S2MM] [get_bd_intf_pins ibert_0/y]
#   connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins s_axi_AXILiteS] [get_bd_intf_pins ibert_0/s_axi_AXILiteS]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins fclk] [get_bd_pins ibert_0/fclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins clk] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins ibert_0/clk]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins rst_n] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins ibert_0/rst_n]
...
#   connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins mm_eval/s_axi_AXILiteS] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
...
#   assign_bd_address -range 0x00010000 -offset 0x43C10000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mm_eval/ibert_0/s_axi_AXILiteS/reg0] -force
