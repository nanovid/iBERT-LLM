...
\begin{document}
    ...
    \node [draw, rectangle, fill=lightGreen, font=\footnotesize, text width=\rectWidth, minimum width=\rectWidth, minimum height=\rectHeight*0.2, above=\rectHeight*0.25pt of Si.north] (coef) {coefs};
